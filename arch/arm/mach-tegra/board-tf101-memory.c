...
static const struct tegra_emc_table tf101_emc_tables_hynix_300Mhz[] = {
	{
		.rate = 25000,   /* SDRAM frequency */
		.regs = {
			0x00000002,   /* RC */
...
static const struct tegra_emc_table tf101_emc_tables_elpida_400Mhz[] = {
	{
...
static const __attribute__((unused)) struct tegra_emc_chip tf101_t25_emc_chips[] = {
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = -1,
		.table = tf101_emc_tables_elpida_400Mhz,
		.table_size = ARRAY_SIZE(tf101_emc_tables_elpida_400Mhz)
	},
};
...
static const __attribute__((unused)) struct tegra_emc_chip tf101_hynix_emc_chips[] = {
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = 0x5454,
		.table = tf101_emc_tables_hynix_300Mhz,
		.table_size = ARRAY_SIZE(tf101_emc_tables_hynix_300Mhz)
	},
};
